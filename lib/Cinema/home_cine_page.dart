...
import 'package:untitled/Cinema/Models/trailers_model.dart';
import 'package:untitled/Cinema/details_movie_page.dart';
import 'package:untitled/Dashboard/Widgets/Widgets.dart';
        ...
        children: [
          ...
          Container(
            ...
            child: ListView.builder(
              physics: BouncingScrollPhysics(),
              scrollDirection: Axis.horizontal,
              itemCount: ComingModel.listMovie.length,
              itemBuilder: (context, i) => _ItemsNowCinemass(comingModel: ComingModel.listMovie[i]),
            ),
          ),
        ],
      ),
...
class _ItemsNowCinemass extends StatelessWidget {

  final ComingModel comingModel;

  const _ItemsNowCinemass({Key? key, required this.comingModel}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => DetailsMoviePagee(comingModel: comingModel))),
      child: Padding(
        padding: const EdgeInsets.only(right: 15.0),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            SizedBox(
              width: 160,
              child: TextFrave(text: comingModel.name, color: Colors.white ),
            ),
            SizedBox(height: 5.0),
            RatingBar.builder(
                itemSize: 22,
      ...
      child: SizedBox(
        ...
        child: Row(
          ...
          children: [
            ...
            TextFrave(text: 'Xem Tất Cả', color: Colors.grey),
          ],
        ),
      ),
    );

...
import 'package:untitled/Cinema/Helpers/painter.dart';
import 'package:untitled/Cinema/Models/armchairs_model.dart';
import 'package:untitled/Cinema/Models/datetime_model.dart';
import 'package:untitled/Cinema/Widgets/seats.dart';
import 'package:untitled/Cinema/details_payment_page.dart';
            ...
            child: Container(
              child: Column(
                children: [
                  ...
                  PainterScreenMovie(),
                  TextFrave(text: 'Màn Hình', color: Colors.white, fontWeight: FontWeight.w500),
          ...
          Positioned(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: TextFrave(text: 'Tiền Vé  \VND ', fontWeight: FontWeight.bold),
              ),
            ),
          ),
        ...
        children: [
          Row(
            children: [
              ...
              SizedBox(width: 10.0),
              TextFrave(text: 'Trống', fontSize: 20, color: Colors.white)
            ],
          ),
          Row(
            children: [
              ...
              SizedBox(width: 10.0),
              TextFrave(text: 'Đã Đặt', fontSize: 20, color: Color(0xff4A5660))
            ],
          ),
          Row(
            children: [
              ...
              SizedBox(width: 10.0),
              TextFrave(text: 'Đang Chọn', fontSize: 20, color: Colors.amber)
            ],
          ),
        ],
      ),

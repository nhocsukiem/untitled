                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            children: [
                              TextFrave(text: 'Ngày', color: Colors.grey, fontSize: 16),
                              TextFrave(text: cinemabloc.state.date),
                            ],
                          ),
                          Column(
                            children: [
                              TextFrave(text: 'Vé', color: Colors.grey, fontSize: 16),
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            children: [
                              TextFrave(text: 'Thời Gian', color: Colors.grey, fontSize: 16),
                              TextFrave(text: cinemabloc.state.time),
                            ],
                          ),
                          Column(
                            children: [
                              TextFrave(text: 'Chỗ Ngồi', color: Colors.grey, fontSize: 16),
                              Row(
